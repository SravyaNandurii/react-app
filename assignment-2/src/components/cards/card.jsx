      ...
      {isHovered ? (
        <div className="hover-content">
          ...
          <button className="card_like"
            ...
            {disliked ? (<ThumbDownAltIcon onClick={handledisliked}/>):(<ThumbDownOffAltIcon onClick={handledisliked}/>)}
            {isliked1 ? (<ThumbUpIcon onClick={handleisliked1}/>):(<ThumbUpOffAltOutlinedIcon onClick={handleisliked1} />)}
            {isliked2 ? (<FavoriteIcon onClick={handleisliked2}/>):(<FavoriteBorderIcon onClick={handleisliked2}/>)}
            </div>
            ):null}
          </button>
